...
// Test ID: ZT-20-TC-005-NEGATIVE
// Type: negative, Priority: P1

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-20: Account lockout is triggered after 5 consecutive failed logi', () => {
  ...
  test('Account lockout is triggered after 5 consecutive failed login attempts', async ({ page }) => {
    ...
    // Step 5: Repeat steps 3-4 four more times
    // Expected: Account lockout is triggered, error message indicates account is locked
  });
});